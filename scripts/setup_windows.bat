...
set "api_job_output_dir=%project_path%\cache\api_job_outputs"
...
if not exist "%api_job_output_dir%" mkdir "%api_job_output_dir%" || (echo Warning: Failed to create API job output directory & goto :error)
